...
BookmarkCollection.parse = function (bookmarks, options) {
  ...
  function addBookmark(bookmark) {
    ...
    unfolderedBookmarks.push(retObj);
  }
  ...
  // TODO: We don't do anything with unfolderedBoomarks
