...
function BookmarkParser(bookmarks, options) {
  ...
  // Parse now
  // TODO: BookmarkParser should parse into a simplified JSON structure
  // TODO: Then, allow for listing of folders and array
  var bookmarksArr = BookmarkParser.parse(bookmarksArr);
...
BookmarkParser.parse = function (bookmarks, options) {
